...
const { whoswho_attempt } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('whoswho_attempt');

// This file contains the logic of every route in Forest Admin for the collection whoswho_attempt:
...
router.post('/whoswho_attempt', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/whoswho_attempt/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/whoswho_attempt/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/whoswho_attempt', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/whoswho_attempt/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/whoswho_attempt/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/whoswho_attempt.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
