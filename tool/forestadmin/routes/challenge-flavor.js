...
const { challenge_flavor } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('challenge_flavor');

// This file contains the logic of every route in Forest Admin for the collection challenge_flavor:
...
router.post('/challenge_flavor', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/challenge_flavor/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/challenge_flavor/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/challenge_flavor', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/challenge_flavor/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/challenge_flavor/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/challenge_flavor.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
