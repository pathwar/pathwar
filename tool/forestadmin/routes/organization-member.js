...
const { organization_member } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('organization_member');

// This file contains the logic of every route in Forest Admin for the collection organization_member:
...
router.post('/organization_member', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/organization_member/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/organization_member/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/organization_member', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/organization_member/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/organization_member/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/organization_member.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
