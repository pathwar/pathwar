...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('team_member');

// This file contains the logic of every route in Forest Admin for the collection team_member:
...
router.post('/team_member', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/team_member/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/team_member/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/team_member', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/team_member/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Team Member
router.get('/team_member/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/team_member.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
