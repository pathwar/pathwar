...
const { challenge_validation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('challenge_validation');

// This file contains the logic of every route in Forest Admin for the collection challenge_validation:
...
router.post('/challenge_validation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/challenge_validation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/challenge_validation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/challenge_validation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/challenge_validation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/challenge_validation/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/challenge_validation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
