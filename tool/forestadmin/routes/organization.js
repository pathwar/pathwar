...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('organization');
...
router.post('/organization', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/organization/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/organization/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/organization', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/organization/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Organization
router.get('/organization/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/organization.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
