...
const { challenge_instance } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('challenge_instance');
...
router.post('/challenge_instance', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/challenge_instance/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/challenge_instance/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/challenge_instance', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/challenge_instance/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/challenge_instance/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/challenge_instance.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
