...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('coupon');

// This file contains the logic of every route in Forest Admin for the collection coupon:
...
// Create a Coupon
router.post('/coupon', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Coupon
router.put('/coupon/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Coupon
router.delete('/coupon/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/coupon', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Coupons
router.get('/coupon/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Coupon
router.get('/coupon/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Coupons
router.get('/coupon.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
