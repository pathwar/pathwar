...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('inventory_item');

// This file contains the logic of every route in Forest Admin for the collection inventory_item:
...
router.post('/inventory_item', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/inventory_item/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/inventory_item/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/inventory_item', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/inventory_item/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/inventory_item/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/inventory_item.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
