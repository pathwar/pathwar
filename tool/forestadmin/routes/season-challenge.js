...
const { season_challenge } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('season_challenge');

// This file contains the logic of every route in Forest Admin for the collection season_challenge:
...
router.post('/season_challenge', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/season_challenge/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/season_challenge/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/season_challenge', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/season_challenge/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/season_challenge/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/season_challenge.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
