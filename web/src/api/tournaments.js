...
export function getAllTournaments() {
    return axios.get(`${process.env.API_URL}/moul/826ef89d52651570a396ef3210a72e40/raw/e95d0e0391abca995949ab1258d5569e0b5ec356/GET%2520tournaments.json`)
...
export function getLevels(tournamentID) {
    return axios.get(`${process.env.API_URL}/moul/826ef89d52651570a396ef3210a72e40/raw/e95d0e0391abca995949ab1258d5569e0b5ec356/GET%2520levels.json`)
    // Uncomment line to use base api with auth token
