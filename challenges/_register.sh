...
pathwar admin challenge-flavor-add --challenge training-sqli --body 'Learn to execute custom code.' --validation-reward 5 --compose-bundle ./web/training-sqli//pathwar-compose.yml
...
pathwar admin challenge-flavor-add --challenge training-brute --body 'Learn to brute force.' --validation-reward 5 --compose-bundle ./web/training-brute//pathwar-compose.yml
...
pathwar admin challenge-flavor-add --challenge captcha-mario --body 'Bypass this Captcha protection.' --validation-reward 15 --purchase-price 5 --compose-bundle ./web/captcha-mario//pathwar-compose.yml
...
pathwar admin challenge-flavor-add --challenge helloworld --body 'Introduction challenge.' --validation-reward 5 --compose-bundle ./web/helloworld//pathwar-compose.yml
...
pathwar admin challenge-flavor-add --challenge training-include --body 'Learn to execute custom code.' --validation-reward 5 --compose-bundle ./web/training-include//pathwar-compose.yml
...
pathwar admin challenge-flavor-add --challenge training-http --body 'Learn to play with HTTP.' --validation-reward 5 --compose-bundle ./web/training-http//pathwar-compose.yml
...
pathwar admin challenge-flavor-add --challenge upload-hi --body 'Execute your code.' --validation-reward 15 --purchase-price 5 --compose-bundle ./web/upload-hi//pathwar-compose.yml
...
pathwar admin challenge-flavor-add --challenge imageboard --body 'The passphrase is commented somewhere in the source.' --validation-reward 15 --purchase-price 5 --compose-bundle ./web/imageboard//pathwar-compose.yml
...
pathwar admin challenge-flavor-add --challenge captcha-luigi --body 'Bypass this Captcha protection.' --validation-reward 15 --purchase-price 5 --compose-bundle ./web/captcha-luigi//pathwar-compose.yml
