...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="span10">
      You need to login as the admin user, but you don't know their password. Luckily (or not :)), the login form is vulnerable to a SQL injection! <br />
      Try to exploit it to connect as the admin! (<b>Hint</b>: Take a look at the OR keyword.)<br />
      The request you must exploit looks like this:<br />
      <div class="code">
