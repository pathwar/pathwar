...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="content">
            <h1>HTTP Cookies</h1>
            <p>HTTP itself is a stateless protocol (meaning that each request is independent), which is problematic for most web applications, as they need to keep track of users' sessions – for example, whether the user is logged in, and what products they've added to their shopping cart.
        To bypass this limitations, HTTP cookies were created.</p>
            <h2>How HTTP cookies work</h2>
...
...
            ...
            <p>Cookies are automatically sent by the client with the header 'Cookie' containing all the valid cookies for the current domain, separated by a semicolon. (You will have the occasion to study this behaviour later in some levels :)). Using the above example, any subsequent request to foo.com will include the two cookies set by the server:</p>
        <div class="code">
            <pre>
GET / HTTP/1.1
Host: foo.com
...
...
        ...
        <p>When you opened this page for the first time, the server sent a cookie named <b>chocolate</b> to your browser.
            As cookie are stored client-side, you can easily modify or delete them.
        ...
        <?php
            if (isset($_COOKIE['chocolate']) && $_COOKIE['chocolate'] == 'isgood') {
                echo 'Congrats! The passphrase is __PASSPHRASE__';
            }
        else {
