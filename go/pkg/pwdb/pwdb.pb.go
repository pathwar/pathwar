...
const (
	...
	Activity_Register Activity_Kind = 1
	Activity_Login    Activity_Kind = 2
)
...
type Activity struct {
	...
	Author                   *User         `protobuf:"bytes,200,opt,name=author,proto3" json:"author,omitempty" gorm:"foreignkey:AuthorID"`
	AuthorID                 int64         `protobuf:"varint,201,opt,name=author_id,json=authorId,proto3" json:"author_id,omitempty" sql:"not null" gorm:"index"`
	TeamSubject              *Team         `protobuf:"bytes,202,opt,name=team_subject,json=teamSubject,proto3" json:"team_subject,omitempty" gorm:"foreignkey:TeamSubjectID"`
	TeamSubjectID            int64         `protobuf:"varint,203,opt,name=team_subject_id,json=teamSubjectId,proto3" json:"team_subject_id,omitempty" sql:"not null" gorm:"index"`
	UserSubject              *User         `protobuf:"bytes,204,opt,name=user_subject,json=userSubject,proto3" json:"user_subject,omitempty" gorm:"foreignkey:UserSubjectID"`
	UserSubjectID            int64         `protobuf:"varint,205,opt,name=user_subject_id,json=userSubjectId,proto3" json:"user_subject_id,omitempty" sql:"not null" gorm:"index"`
	OrganizationSubject      *Organization `protobuf:"bytes,206,opt,name=organization_subject,json=organizationSubject,proto3" json:"organization_subject,omitempty" gorm:"foreignkey:OrganizationSubjectID"`
	OrganizationSubjectID    int64         `protobuf:"varint,207,opt,name=organization_subject_id,json=organizationSubjectId,proto3" json:"organization_subject_id,omitempty" sql:"not null" gorm:"index"`
	SeasonSubject            *Season       `protobuf:"bytes,208,opt,name=season_subject,json=seasonSubject,proto3" json:"season_subject,omitempty" gorm:"foreignkey:SeasonSubjectID"`
	SeasonSubjectID          int64         `protobuf:"varint,209,opt,name=season_subject_id,json=seasonSubjectId,proto3" json:"season_subject_id,omitempty" sql:"not null" gorm:"index"`
	ChallengeSubject         *Team         `protobuf:"bytes,210,opt,name=challenge_subject,json=challengeSubject,proto3" json:"challenge_subject,omitempty" gorm:"foreignkey:ChallengeSubjectID"`
	ChallengeSubjectID       int64         `protobuf:"varint,211,opt,name=challenge_subject_id,json=challengeSubjectId,proto3" json:"challenge_subject_id,omitempty" sql:"not null" gorm:"index"`
	ChallengeFlavorSubject   *Team         `protobuf:"bytes,212,opt,name=challenge_flavor_subject,json=challengeFlavorSubject,proto3" json:"challenge_flavor_subject,omitempty" gorm:"foreignkey:ChallengeFlavorSubjectID"`
	ChallengeFlavorSubjectID int64         `protobuf:"varint,213,opt,name=challenge_flavor_subject_id,json=challengeFlavorSubjectId,proto3" json:"challenge_flavor_subject_id,omitempty" sql:"not null" gorm:"index"`
	CouponSubject            *Team         `protobuf:"bytes,214,opt,name=coupon_subject,json=couponSubject,proto3" json:"coupon_subject,omitempty" gorm:"foreignkey:CouponSubjectID"`
	CouponSubjectID          int64         `protobuf:"varint,215,opt,name=coupon_subject_id,json=couponSubjectId,proto3" json:"coupon_subject_id,omitempty" sql:"not null" gorm:"index"`
	SeasonChallengeSubject   *Season       `protobuf:"bytes,216,opt,name=season_challenge_subject,json=seasonChallengeSubject,proto3" json:"season_challenge_subject,omitempty" gorm:"foreignkey:SeasonChallengeSubjectID"`
	SeasonChallengeSubjectID int64         `protobuf:"varint,217,opt,name=season_challenge_subject_id,json=seasonChallengeSubjectId,proto3" json:"season_challenge_subject_id,omitempty" sql:"not null" gorm:"index"`
	TeamMemberSubject        *Team         `protobuf:"bytes,218,opt,name=team_member_subject,json=teamMemberSubject,proto3" json:"team_member_subject,omitempty" gorm:"foreignkey:TeamMemberSubjectID"`
	TeamMemberSubjectID      int64         `protobuf:"varint,219,opt,name=team_member_subject_id,json=teamMemberSubjectId,proto3" json:"team_member_subject_id,omitempty" sql:"not null" gorm:"index"`
}
...
func (m *Activity) GetTeamSubject() *Team {
	if m != nil {
		return m.TeamSubject
	}
	return nil
}

func (m *Activity) GetTeamSubjectID() int64 {
	if m != nil {
		return m.TeamSubjectID
	}
	return 0
}

func (m *Activity) GetUserSubject() *User {
	if m != nil {
		return m.UserSubject
	}
	return nil
}

func (m *Activity) GetUserSubjectID() int64 {
	if m != nil {
		return m.UserSubjectID
	}
	return 0
}

func (m *Activity) GetOrganizationSubject() *Organization {
	if m != nil {
		return m.OrganizationSubject
	}
	return nil
}

func (m *Activity) GetOrganizationSubjectID() int64 {
	if m != nil {
		return m.OrganizationSubjectID
	}
	return 0
}

func (m *Activity) GetSeasonSubject() *Season {
	if m != nil {
		return m.SeasonSubject
	}
	return nil
}

func (m *Activity) GetSeasonSubjectID() int64 {
	if m != nil {
		return m.SeasonSubjectID
	}
	return 0
}

func (m *Activity) GetChallengeSubject() *Team {
	if m != nil {
		return m.ChallengeSubject
	}
	return nil
}

func (m *Activity) GetChallengeSubjectID() int64 {
	if m != nil {
		return m.ChallengeSubjectID
	}
	return 0
}

func (m *Activity) GetChallengeFlavorSubject() *Team {
	if m != nil {
		return m.ChallengeFlavorSubject
	}
	return nil
}

func (m *Activity) GetChallengeFlavorSubjectID() int64 {
	if m != nil {
		return m.ChallengeFlavorSubjectID
	}
	return 0
}

func (m *Activity) GetCouponSubject() *Team {
	if m != nil {
		return m.CouponSubject
	}
	return nil
}

func (m *Activity) GetCouponSubjectID() int64 {
	if m != nil {
		return m.CouponSubjectID
	}
	return 0
}

func (m *Activity) GetSeasonChallengeSubject() *Season {
	if m != nil {
		return m.SeasonChallengeSubject
	}
	return nil
}

func (m *Activity) GetSeasonChallengeSubjectID() int64 {
	if m != nil {
		return m.SeasonChallengeSubjectID
	}
	return 0
}

func (m *Activity) GetTeamMemberSubject() *Team {
	if m != nil {
		return m.TeamMemberSubject
	}
	return nil
}

func (m *Activity) GetTeamMemberSubjectID() int64 {
	if m != nil {
		return m.TeamMemberSubjectID
	}
	return 0
}
...
var fileDescriptor_debbe06253822cef = []byte{
	...
	,
}
...
func (m *Activity) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TeamMemberSubjectID != 0 {
		i = encodeVarintPwdb(dAtA, i, uint64(m.TeamMemberSubjectID))
		i--
		dAtA[i] = 0xd
		i--
		dAtA[i] = 0xd8
	}
	if m.TeamMemberSubject != nil {
		{
			size, err := m.TeamMemberSubject.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.SeasonChallengeSubjectID != 0 {
		i = encodeVarintPwdb(dAtA, i, uint64(m.SeasonChallengeSubjectID))
		i--
		dAtA[i] = 0xd
		i--
		dAtA[i] = 0xc8
	}
	if m.SeasonChallengeSubject != nil {
		{
			size, err := m.SeasonChallengeSubject.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.CouponSubjectID != 0 {
		i = encodeVarintPwdb(dAtA, i, uint64(m.CouponSubjectID))
		i--
		dAtA[i] = 0xd
		i--
		dAtA[i] = 0xb8
	}
	if m.CouponSubject != nil {
		{
			size, err := m.CouponSubject.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.ChallengeFlavorSubjectID != 0 {
		i = encodeVarintPwdb(dAtA, i, uint64(m.ChallengeFlavorSubjectID))
		i--
		dAtA[i] = 0xd
		i--
		dAtA[i] = 0xa8
	}
	if m.ChallengeFlavorSubject != nil {
		{
			size, err := m.ChallengeFlavorSubject.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.ChallengeSubjectID != 0 {
		i = encodeVarintPwdb(dAtA, i, uint64(m.ChallengeSubjectID))
		i--
		dAtA[i] = 0xd
		i--
		dAtA[i] = 0x98
	}
	if m.ChallengeSubject != nil {
		{
			size, err := m.ChallengeSubject.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.SeasonSubjectID != 0 {
		i = encodeVarintPwdb(dAtA, i, uint64(m.SeasonSubjectID))
		i--
		dAtA[i] = 0xd
		i--
		dAtA[i] = 0x88
	}
	if m.SeasonSubject != nil {
		{
			size, err := m.SeasonSubject.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.OrganizationSubjectID != 0 {
		i = encodeVarintPwdb(dAtA, i, uint64(m.OrganizationSubjectID))
		i--
		dAtA[i] = 0xc
		i--
		dAtA[i] = 0xf8
	}
	if m.OrganizationSubject != nil {
		{
			size, err := m.OrganizationSubject.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.UserSubjectID != 0 {
		i = encodeVarintPwdb(dAtA, i, uint64(m.UserSubjectID))
		i--
		dAtA[i] = 0xc
		i--
		dAtA[i] = 0xe8
	}
	if m.UserSubject != nil {
		{
			size, err := m.UserSubject.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.TeamSubjectID != 0 {
		i = encodeVarintPwdb(dAtA, i, uint64(m.TeamSubjectID))
		i--
		dAtA[i] = 0xc
		i--
		dAtA[i] = 0xd8
	}
	if m.TeamSubject != nil {
		{
			size, err := m.TeamSubject.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.UpdatedAt != nil {
		n92, err92 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.UpdatedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.UpdatedAt):])
		if err92 != nil {
			return 0, err92
		}
		i -= n92
		i = encodeVarintPwdb(dAtA, i, uint64(n92))
		i--
		dAtA[i] = 0x1a
	}
	if m.CreatedAt != nil {
		n93, err93 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.CreatedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.CreatedAt):])
		if err93 != nil {
			return 0, err93
		}
		i -= n93
...
func (m *Activity) Size() (n int) {
	...
	if m.TeamSubject != nil {
		l = m.TeamSubject.Size()
		n += 2 + l + sovPwdb(uint64(l))
	}
	if m.TeamSubjectID != 0 {
		n += 2 + sovPwdb(uint64(m.TeamSubjectID))
	}
	if m.UserSubject != nil {
		l = m.UserSubject.Size()
		n += 2 + l + sovPwdb(uint64(l))
	}
	if m.UserSubjectID != 0 {
		n += 2 + sovPwdb(uint64(m.UserSubjectID))
	}
	if m.OrganizationSubject != nil {
		l = m.OrganizationSubject.Size()
		n += 2 + l + sovPwdb(uint64(l))
	}
	if m.OrganizationSubjectID != 0 {
		n += 2 + sovPwdb(uint64(m.OrganizationSubjectID))
	}
	if m.SeasonSubject != nil {
		l = m.SeasonSubject.Size()
		n += 2 + l + sovPwdb(uint64(l))
	}
	if m.SeasonSubjectID != 0 {
		n += 2 + sovPwdb(uint64(m.SeasonSubjectID))
	}
	if m.ChallengeSubject != nil {
		l = m.ChallengeSubject.Size()
		n += 2 + l + sovPwdb(uint64(l))
	}
	if m.ChallengeSubjectID != 0 {
		n += 2 + sovPwdb(uint64(m.ChallengeSubjectID))
	}
	if m.ChallengeFlavorSubject != nil {
		l = m.ChallengeFlavorSubject.Size()
		n += 2 + l + sovPwdb(uint64(l))
	}
	if m.ChallengeFlavorSubjectID != 0 {
		n += 2 + sovPwdb(uint64(m.ChallengeFlavorSubjectID))
	}
	if m.CouponSubject != nil {
		l = m.CouponSubject.Size()
		n += 2 + l + sovPwdb(uint64(l))
	}
	if m.CouponSubjectID != 0 {
		n += 2 + sovPwdb(uint64(m.CouponSubjectID))
	}
	if m.SeasonChallengeSubject != nil {
		l = m.SeasonChallengeSubject.Size()
		n += 2 + l + sovPwdb(uint64(l))
	}
	if m.SeasonChallengeSubjectID != 0 {
		n += 2 + sovPwdb(uint64(m.SeasonChallengeSubjectID))
	}
	if m.TeamMemberSubject != nil {
		l = m.TeamMemberSubject.Size()
		n += 2 + l + sovPwdb(uint64(l))
	}
	if m.TeamMemberSubjectID != 0 {
		n += 2 + sovPwdb(uint64(m.TeamMemberSubjectID))
	}
	return n
}
...
func (m *Activity) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 202:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TeamSubject", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.TeamSubject.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 203:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TeamSubjectID", wireType)
			}
			m.TeamSubjectID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TeamSubjectID |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 204:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UserSubject", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.UserSubject.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 205:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UserSubjectID", wireType)
			}
			m.UserSubjectID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UserSubjectID |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 206:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OrganizationSubject", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.OrganizationSubject == nil {
				m.OrganizationSubject = &Organization{}
			}
			if err := m.OrganizationSubject.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 207:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OrganizationSubjectID", wireType)
			}
			m.OrganizationSubjectID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPwdb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OrganizationSubjectID |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 208:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SeasonSubject", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SeasonSubject == nil {
				m.SeasonSubject = &Season{}
			}
			if err := m.SeasonSubject.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 209:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SeasonSubjectID", wireType)
			}
			m.SeasonSubjectID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SeasonSubjectID |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 210:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChallengeSubject", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ChallengeSubject == nil {
				m.ChallengeSubject = &Team{}
			}
			if err := m.ChallengeSubject.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 211:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChallengeSubjectID", wireType)
			}
			m.ChallengeSubjectID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPwdb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ChallengeSubjectID |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 212:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChallengeFlavorSubject", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ChallengeFlavorSubject == nil {
				m.ChallengeFlavorSubject = &Team{}
			}
			if err := m.ChallengeFlavorSubject.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 213:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChallengeFlavorSubjectID", wireType)
			}
			m.ChallengeFlavorSubjectID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPwdb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ChallengeFlavorSubjectID |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 214:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CouponSubject", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CouponSubject == nil {
				m.CouponSubject = &Team{}
			}
			if err := m.CouponSubject.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 215:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CouponSubjectID", wireType)
			}
			m.CouponSubjectID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CouponSubjectID |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 216:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SeasonChallengeSubject", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SeasonChallengeSubject == nil {
				m.SeasonChallengeSubject = &Season{}
			}
			if err := m.SeasonChallengeSubject.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 217:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SeasonChallengeSubjectID", wireType)
			}
			m.SeasonChallengeSubjectID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPwdb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SeasonChallengeSubjectID |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 218:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TeamMemberSubject", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TeamMemberSubject == nil {
				m.TeamMemberSubject = &Team{}
			}
			if err := m.TeamMemberSubject.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 219:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TeamMemberSubjectID", wireType)
			}
			m.TeamMemberSubjectID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPwdb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TeamMemberSubjectID |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
