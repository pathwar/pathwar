...
type Challenge struct {
	...
	Slug        string             `protobuf:"bytes,107,opt,name=slug,proto3" json:"slug,omitempty" gorm:"uniqueIndex"`
	Flavors     []*ChallengeFlavor `protobuf:"bytes,200,rep,name=flavors,proto3" json:"flavors,omitempty" yaml:"flavors,omitempty"`
}
...
type ChallengeFlavor struct {
	...
	Slug               string                          `protobuf:"bytes,109,opt,name=slug,proto3" json:"slug,omitempty" gorm:"uniqueIndex"`
	...
	ChallengeID        int64                           `protobuf:"varint,201,opt,name=challenge_id,json=challengeId,proto3" json:"challenge_id,omitempty" gorm:"index" yaml:"challenge_id,omitempty"`
	SeasonChallenges   []*SeasonChallenge              `protobuf:"bytes,202,rep,name=season_challenges,json=seasonChallenges,proto3" json:"season_challenges,omitempty" gorm:"foreignKey:FlavorID" yaml:"season_challenges,omitempty"`
	Instances          []*ChallengeInstance            `protobuf:"bytes,203,rep,name=instances,proto3" json:"instances,omitempty" gorm:"foreignKey:FlavorID" yaml:"instances,omitempty"`
}
...
type SeasonChallenge struct {
	...
	FlavorID      int64                    `protobuf:"varint,201,opt,name=flavor_id,json=flavorId,proto3" json:"flavor_id,omitempty" gorm:"uniqueIndex:idx_seasonchallenge_flavor_season"`
	Season        *Season                  `protobuf:"bytes,202,opt,name=season,proto3" json:"season,omitempty" gorm:"foreignKey:SeasonID"`
	SeasonID      int64                    `protobuf:"varint,203,opt,name=season_id,json=seasonId,proto3" json:"season_id,omitempty" gorm:"uniqueIndex:idx_seasonchallenge_flavor_season"`
	Subscriptions []*ChallengeSubscription `protobuf:"bytes,204,rep,name=subscriptions,proto3" json:"subscriptions,omitempty"`
}
...
type ChallengeInstance struct {
	...
	Agent    *Agent           `protobuf:"bytes,200,opt,name=agent,proto3" json:"agent,omitempty"`
	AgentID  int64            `protobuf:"varint,201,opt,name=agent_id,json=agentId,proto3" json:"agent_id,omitempty" gorm:"index"`
	Flavor   *ChallengeFlavor `protobuf:"bytes,202,opt,name=flavor,proto3" json:"flavor,omitempty"`
	FlavorID int64            `protobuf:"varint,203,opt,name=flavor_id,json=flavorId,proto3" json:"flavor_id,omitempty" gorm:"index"`
	/// non-db fields
...
type Agent struct {
	...
	ChallengeInstances []*ChallengeInstance `protobuf:"bytes,200,rep,name=challenge_instances,json=challengeInstances,proto3" json:"challenge_instances,omitempty"`
}
...
type OrganizationMember struct {
	...
	UserID         int64                   `protobuf:"varint,200,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty" gorm:"index"`
	User           *User                   `protobuf:"bytes,201,opt,name=user,proto3" json:"user,omitempty"`
	OrganizationID int64                   `protobuf:"varint,202,opt,name=organization_id,json=organizationId,proto3" json:"organization_id,omitempty" gorm:"index"`
	Organization   *Organization           `protobuf:"bytes,203,opt,name=organization,proto3" json:"organization,omitempty"`
}
...
type TeamMember struct {
	...
	// belongs to
	UserID int64 `protobuf:"varint,200,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty" gorm:"index"`
	User   *User `protobuf:"bytes,201,opt,name=user,proto3" json:"user,omitempty" gorm:"foreignKey:UserID;references:ID"`
	// has one
	ActiveUser *User `protobuf:"bytes,202,opt,name=active_user,json=activeUser,proto3" json:"active_user,omitempty" gorm:"foreignKey:ActiveTeamMemberID;references:ID"`
	Team       *Team `protobuf:"bytes,203,opt,name=team,proto3" json:"team,omitempty"`
	TeamID     int64 `protobuf:"varint,204,opt,name=team_id,json=teamId,proto3" json:"team_id,omitempty" gorm:"index"`
	...
	Items []*InventoryItem `protobuf:"bytes,205,rep,name=items,proto3" json:"items,omitempty" gorm:"foreignKey:OwnerID"`
}
...
func (m *TeamMember) GetActiveUser() *User {
	if m != nil {
		return m.ActiveUser
	}
	return nil
...
type TeamInvite struct {
	...
	UserID    int64      `protobuf:"varint,200,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty" gorm:"index"`
	User      *User      `protobuf:"bytes,201,opt,name=user,proto3" json:"user,omitempty"`
	TeamID    int64      `protobuf:"varint,202,opt,name=team_id,json=teamId,proto3" json:"team_id,omitempty" gorm:"index"`
	Team      *Team      `protobuf:"bytes,203,opt,name=team,proto3" json:"team,omitempty"`
}
...
type User struct {
	...
	OAuthSubject            string                `protobuf:"bytes,105,opt,name=oauth_subject,json=oauthSubject,proto3" json:"oauth_subject,omitempty" gorm:"uniqueIndex"`
	...
	Slug                    string                `protobuf:"bytes,108,opt,name=slug,proto3" json:"slug,omitempty"`
	TeamMemberships         []*TeamMember         `protobuf:"bytes,200,rep,name=team_memberships,json=teamMemberships,proto3" json:"team_memberships,omitempty"`
	Notifications           []*Notification       `protobuf:"bytes,201,rep,name=notifications,proto3" json:"notifications,omitempty"`
	OrganizationMemberships []*OrganizationMember `protobuf:"bytes,202,rep,name=organization_memberships,json=organizationMemberships,proto3" json:"organization_memberships,omitempty"`
	ActiveTeamMemberID      int64                 `protobuf:"varint,203,opt,name=active_team_member_id,json=activeTeamMemberId,proto3" json:"active_team_member_id,omitempty" gorm:"index"`
	ActiveTeamMember        *TeamMember           `protobuf:"bytes,204,opt,name=active_team_member,json=activeTeamMember,proto3" json:"active_team_member,omitempty" gorm:"foreignKey:ActiveTeamMemberID;references:ID"`
	ActiveSeasonID          int64                 `protobuf:"varint,205,opt,name=active_season_id,json=activeSeasonId,proto3" json:"active_season_id,omitempty" gorm:"index"`
	ActiveSeason            *Season               `protobuf:"bytes,206,opt,name=active_season,json=activeSeason,proto3" json:"active_season,omitempty" gorm:"foreignKey:ActiveSeasonID"`
}
...
type Organization struct {
	...
	Teams          []*Team        `protobuf:"bytes,200,rep,name=teams,proto3" json:"teams,omitempty"`
	//repeated WhoswhoAttempt received_whoswho_attempts = 201;
	Members []*OrganizationMember `protobuf:"bytes,201,rep,name=members,proto3" json:"members,omitempty"`
}
...
type Season struct {
	...
	Teams        []*Team             `protobuf:"bytes,200,rep,name=teams,proto3" json:"teams,omitempty"`
	Coupons      []*Coupon           `protobuf:"bytes,201,rep,name=coupons,proto3" json:"coupons,omitempty"`
}
...
type Team struct {
	...
	SeasonID               int64                    `protobuf:"varint,201,opt,name=season_id,json=seasonId,proto3" json:"season_id,omitempty" gorm:"uniqueIndex:idx_team_season_organization"`
	...
	OrganizationID         int64                    `protobuf:"varint,203,opt,name=organization_id,json=organizationId,proto3" json:"organization_id,omitempty" gorm:"uniqueIndex:idx_team_season_organization"`
	ChallengeSubscriptions []*ChallengeSubscription `protobuf:"bytes,205,rep,name=challenge_subscriptions,json=challengeSubscriptions,proto3" json:"challenge_subscriptions,omitempty"`
	Members                []*TeamMember            `protobuf:"bytes,206,rep,name=members,proto3" json:"members,omitempty"`
	Achievements           []*Achievement           `protobuf:"bytes,207,rep,name=achievements,proto3" json:"achievements,omitempty"`
}
...
type WhoswhoAttempt struct {
	...
	AuthorID     int64      `protobuf:"varint,201,opt,name=author_id,json=authorId,proto3" json:"author_id,omitempty" gorm:"index"`
	AuthorTeam   *Team      `protobuf:"bytes,202,opt,name=author_team,json=authorTeam,proto3" json:"author_team,omitempty" gorm:"foreignKey:AuthorTeamID"`
	AuthorTeamID int64      `protobuf:"varint,203,opt,name=author_team_id,json=authorTeamId,proto3" json:"author_team_id,omitempty" gorm:"index"`
	TargetUser   *User      `protobuf:"bytes,204,opt,name=target_user,json=targetUser,proto3" json:"target_user,omitempty" gorm:"foreignKey:TargetUserID"`
	TargetUserID int64      `protobuf:"varint,205,opt,name=target_user_id,json=targetUserId,proto3" json:"target_user_id,omitempty" gorm:"index"`
	TargetTeam   *Team      `protobuf:"bytes,206,opt,name=target_team,json=targetTeam,proto3" json:"target_team,omitempty" gorm:"foreignKey:TargetTeamID"`
	TargetTeamID int64      `protobuf:"varint,207,opt,name=target_team_id,json=targetTeamId,proto3" json:"target_team_id,omitempty" gorm:"index"`
}
...
type ChallengeValidation struct {
	...
	ChallengeSubscriptionID int64                      `protobuf:"varint,200,opt,name=challenge_subscription_id,json=challengeSubscriptionId,proto3" json:"challenge_subscription_id,omitempty" gorm:"index"`
	ChallengeSubscription   *ChallengeSubscription     `protobuf:"bytes,201,opt,name=challenge_subscription,json=challengeSubscription,proto3" json:"challenge_subscription,omitempty"`
	AuthorID                int64                      `protobuf:"varint,202,opt,name=author_id,json=authorId,proto3" json:"author_id,omitempty" gorm:"index"`
	Author                  *User                      `protobuf:"bytes,203,opt,name=author,proto3" json:"author,omitempty" gorm:"foreignKey:AuthorID"`
	TeamID                  int64                      `protobuf:"varint,204,opt,name=team_id,json=teamId,proto3" json:"team_id,omitempty" gorm:"index"`
	Team                    *Team                      `protobuf:"bytes,205,opt,name=team,proto3" json:"team,omitempty"`
}
...
type ChallengeSubscription struct {
	...
	TeamID            int64                        `protobuf:"varint,201,opt,name=team_id,json=teamId,proto3" json:"team_id,omitempty" gorm:"uniqueIndex:idx_team_season_challenge"`
	...
	SeasonChallengeID int64                        `protobuf:"varint,203,opt,name=season_challenge_id,json=seasonChallengeId,proto3" json:"season_challenge_id,omitempty" gorm:"uniqueIndex:idx_team_season_challenge"`
	Buyer             *User                        `protobuf:"bytes,204,opt,name=buyer,proto3" json:"buyer,omitempty" gorm:"foreignKey:BuyerID"`
	BuyerID           int64                        `protobuf:"varint,205,opt,name=buyer_id,json=buyerId,proto3" json:"buyer_id,omitempty" gorm:"index"`
	...
	Validations       []*ChallengeValidation       `protobuf:"bytes,208,rep,name=validations,proto3" json:"validations,omitempty"`
}
...
type InventoryItem struct {
	...
	OwnerID   int64              `protobuf:"varint,201,opt,name=owner_id,json=ownerId,proto3" json:"owner_id,omitempty" gorm:"index"`
}
...
type Notification struct {
	...
	UserID    int64      `protobuf:"varint,201,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty" gorm:"index"`
}
...
type Coupon struct {
	...
	CreatedAt          *time.Time          `protobuf:"bytes,2,opt,name=created_at,json=createdAt,proto3,stdtime" json:"created_at,omitempty"`
	UpdatedAt          *time.Time          `protobuf:"bytes,3,opt,name=updated_at,json=updatedAt,proto3,stdtime" json:"updated_at,omitempty"`
	Hash               string              `protobuf:"bytes,100,opt,name=hash,proto3" json:"hash,omitempty" gorm:"uniqueIndex"`
	...
	Validations        []*CouponValidation `protobuf:"bytes,202,rep,name=validations,proto3" json:"validations,omitempty"`
}
...
type CouponValidation struct {
	...
	AuthorID  int64      `protobuf:"varint,200,opt,name=author_id,json=authorId,proto3" json:"author_id,omitempty" gorm:"index"`
	Author    *User      `protobuf:"bytes,201,opt,name=author,proto3" json:"author,omitempty" gorm:"foreignKey:AuthorID"`
	TeamID    int64      `protobuf:"varint,202,opt,name=team_id,json=teamId,proto3" json:"team_id,omitempty" gorm:"index"`
	Team      *Team      `protobuf:"bytes,203,opt,name=team,proto3" json:"team,omitempty"`
	CouponID  int64      `protobuf:"varint,204,opt,name=coupon_id,json=couponId,proto3" json:"coupon_id,omitempty" gorm:"index"`
	Coupon    *Coupon    `protobuf:"bytes,205,opt,name=coupon,proto3" json:"coupon,omitempty"`
}
...
type Achievement struct {
	...
	TeamID                int64                `protobuf:"varint,203,opt,name=team_id,json=teamId,proto3" json:"team_id,omitempty" gorm:"index"`
	...
	ChallengeValidationID int64                `protobuf:"varint,205,opt,name=challenge_validation_id,json=challengeValidationId,proto3" json:"challenge_validation_id,omitempty" gorm:"index"`
}
...
type Activity struct {
	...
	UserID                  int64                  `protobuf:"varint,205,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty" gorm:"index"`
	...
	OrganizationID          int64                  `protobuf:"varint,207,opt,name=organization_id,json=organizationId,proto3" json:"organization_id,omitempty" gorm:"index"`
	Season                  *Season                `protobuf:"bytes,208,opt,name=season,proto3" json:"season,omitempty" gorm:"foreignKey:SeasonID"`
	SeasonID                int64                  `protobuf:"varint,209,opt,name=season_id,json=seasonId,proto3" json:"season_id,omitempty" gorm:"index"`
	Challenge               *Challenge             `protobuf:"bytes,210,opt,name=challenge,proto3" json:"challenge,omitempty" gorm:"foreignKey:ChallengeID"`
	ChallengeID             int64                  `protobuf:"varint,211,opt,name=challenge_id,json=challengeId,proto3" json:"challenge_id,omitempty" gorm:"index"`
	...
	ChallengeFlavorID       int64                  `protobuf:"varint,213,opt,name=challenge_flavor_id,json=challengeFlavorId,proto3" json:"challenge_flavor_id,omitempty" gorm:"index"`
	Coupon                  *Coupon                `protobuf:"bytes,214,opt,name=coupon,proto3" json:"coupon,omitempty" gorm:"foreignKey:CouponID"`
	CouponID                int64                  `protobuf:"varint,215,opt,name=coupon_id,json=couponId,proto3" json:"coupon_id,omitempty" gorm:"index"`
	...
	SeasonChallengeID       int64                  `protobuf:"varint,217,opt,name=season_challenge_id,json=seasonChallengeId,proto3" json:"season_challenge_id,omitempty" gorm:"index"`
	...
	TeamMemberID            int64                  `protobuf:"varint,219,opt,name=team_member_id,json=teamMemberId,proto3" json:"team_member_id,omitempty" gorm:"index"`
	...
	ChallengeSubscriptionID int64                  `protobuf:"varint,221,opt,name=challenge_subscription_id,json=challengeSubscriptionId,proto3" json:"challenge_subscription_id,omitempty" gorm:"index"`
	...
	ChallengeInstanceID     int64                  `protobuf:"varint,223,opt,name=challenge_instance_id,json=challengeInstanceId,proto3" json:"challenge_instance_id,omitempty" gorm:"index"`
	Agent                   *Agent                 `protobuf:"bytes,224,opt,name=agent,proto3" json:"agent,omitempty" gorm:"foreignKey:AgentID"`
	AgentID                 int64                  `protobuf:"varint,225,opt,name=agent_id,json=agentId,proto3" json:"agent_id,omitempty" gorm:"index"`
	...
	TeamInviteID            int64                  `protobuf:"varint,227,opt,name=team_invite_id,json=teamInviteId,proto3" json:"team_invite_id,omitempty" gorm:"index"`
}
...
type Info struct {
	TableRows map[string]int64 `protobuf:"bytes,1,rep,name=table_rows,json=tableRows,proto3" json:"table_rows,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (m *Info) GetTableRows() map[string]int64 {
	if m != nil {
		return m.TableRows
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]int64)(nil), "pathwar.db.Info.TableRowsEntry")
...
var fileDescriptor_debbe06253822cef = []byte{
	...
	,
}
...
func (m *TeamMember) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ActiveUser != nil {
		{
			size, err := m.ActiveUser.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TeamInvite) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DeletedAt != nil {
		n32, err32 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.DeletedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.DeletedAt):])
		if err32 != nil {
			return 0, err32
		}
		i -= n32
...
func (m *User) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DeletedAt != nil {
		n37, err37 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.DeletedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.DeletedAt):])
		if err37 != nil {
			return 0, err37
		}
		i -= n37
...
func (m *Organization) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DeletedAt != nil {
		n40, err40 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.DeletedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.DeletedAt):])
		if err40 != nil {
			return 0, err40
		}
		i -= n40
...
func (m *Team) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DeletedAt != nil {
		n47, err47 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.DeletedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.DeletedAt):])
		if err47 != nil {
			return 0, err47
		}
		i -= n47
...
func (m *ChallengeSubscription) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ClosedAt != nil {
		n65, err65 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.ClosedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.ClosedAt):])
		if err65 != nil {
			return 0, err65
		}
		i -= n65
...
func (m *Notification) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ReadAt != nil {
		n72, err72 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.ReadAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.ReadAt):])
		if err72 != nil {
			return 0, err72
		}
		i -= n72
...
func (m *Achievement) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.UpdatedAt != nil {
		n86, err86 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.UpdatedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.UpdatedAt):])
		if err86 != nil {
			return 0, err86
		}
		i -= n86
	...
	if m.CreatedAt != nil {
		n87, err87 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.CreatedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.CreatedAt):])
		if err87 != nil {
			return 0, err87
		}
		i -= n87
		i = encodeVarintPwdb(dAtA, i, uint64(n87))
		i--
		dAtA[i] = 0x12
	}
	if m.ID != 0 {
...
func (m *Activity) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.UpdatedAt != nil {
		n102, err102 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.UpdatedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.UpdatedAt):])
		if err102 != nil {
			return 0, err102
		}
		i -= n102
	...
	if m.CreatedAt != nil {
		n103, err103 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.CreatedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.CreatedAt):])
		if err103 != nil {
			return 0, err103
		}
		i -= n103
		i = encodeVarintPwdb(dAtA, i, uint64(n103))
		i--
		dAtA[i] = 0x12
	}
	if m.ID != 0 {
...
func (m *TeamMember) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 202:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ActiveUser", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ActiveUser.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 203:
