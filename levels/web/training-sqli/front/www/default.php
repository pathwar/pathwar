<div class="container-fluid">
  <div class="row">
	...
	<ul>
	  <li>
	    <p><a href="https://en.wikipedia.org/wiki/SQL_injection">Wikipedia</a></p>
	  </li>
	  <li>
	    <p><a href="https://www.owasp.org/index.php/SQL_Injection">OWASP</a></p>
	  </li>
	  <li>
	    <p><a href="https://dev.mysql.com/doc/">MySQL Documentation</a></p>
	  </li>
	</ul>
    </div>
  </div>
